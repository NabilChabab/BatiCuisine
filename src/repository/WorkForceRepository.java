...
public class WorkForceRepository implements WorkForceInterface<WorkForce> {
    ...
    public WorkForceRepository(ComponentRepository componentRepository) throws SQLException {
    ...
    public WorkForce save(WorkForce workForce) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
            preparedStatement.setInt(1, workForce.getId());
            ...
            preparedStatement.setInt(6, workForce.getProject().getId());
    ...
    public WorkForce update(WorkForce workForce) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
            ...
            preparedStatement.setDouble(4, workForce.getWorkingHours());
            preparedStatement.setDouble(5, workForce.getWorkerProductivity());
            preparedStatement.setInt(6, workForce.getId());
    ...
    @Override
    public List<WorkForce> findAllByProjectId(int id) {
        List<WorkForce> workforces = new ArrayList<>();
